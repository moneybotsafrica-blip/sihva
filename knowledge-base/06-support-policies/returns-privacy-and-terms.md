---
id: KB-POLICY-001
title: Returns, privacy, and order terms
category: support-policies
tags: [returns, refund, privacy, terms, cancellation]
audience: [customer, support-agent]
visibility: customer
source: [frontend/src/components/info/InfoPage.jsx]
confidence: medium
---

# Returns, privacy, and order terms
...
The site presents a return policy, but no public self-service return or cancellation endpoint exists. Support must follow an approved manual process for return approval, refunds, and cancellation requests.
